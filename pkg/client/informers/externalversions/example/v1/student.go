...
import (
	...
	versioned "crd_controller/pkg/client/clientset/versioned"
	internalinterfaces "crd_controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "crd_controller/pkg/client/listers/example/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&examplev1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1.Student{}, f.defaultInformer)
}
