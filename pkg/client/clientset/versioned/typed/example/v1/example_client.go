...
import (
	v1 "crd_controller/pkg/apis/example/v1"
	"crd_controller/pkg/client/clientset/versioned/scheme"
	"net/http"
...
// ExampleV1Client is used to interact with features provided by the example.k8s.io group.
type ExampleV1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1Client) Students(namespace string) StudentInterface {
